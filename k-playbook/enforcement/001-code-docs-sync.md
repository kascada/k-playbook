# Enforcement: Code und Docs synchron halten
...
> Ich habe Code geändert, finde aber keine eindeutig betroffene Doku. Soll ich eine bestehende Doku ergänzen, eine neue Notiz anlegen oder es bewusst undokumentiert lassen?
